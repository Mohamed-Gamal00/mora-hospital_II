                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            <h2>{{ trans('Dashboard/login_trans.Wellcome_back') }}</h2>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="sectionchoocer">
                                                    <option value="" selected disabled>{{ trans('Dashboard/login_trans.choose_list') }}
                                                    </option>
...
@section('js')
    <script>
        $('#sectionchoocer').change(function() {
            var myID = $(this).val();
